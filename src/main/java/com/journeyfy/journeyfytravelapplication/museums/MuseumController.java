...
public class MuseumController {
    ...
    public static List<MuseumModel> allMuseums = Arrays.asList(
            new MuseumModel(1L,
            ...
            new MuseumModel(2L,
                    ...
                    11.35,
                    "Valencia",
                    "https://mhv.valencia.es/"
            ),
            new MuseumModel(3L, "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0f/a3/92/30/el-museo-vista-desde.jpg?w=1200&h=-1&s=1",
                    ...
                    5,
                    "Valencia",
                    "https://museobellasartesvalencia.gva.es/va/"
            ),
            new MuseumModel(4L,
            ...
            new MuseumModel(2L,
                    ...
                    "Parc de Montjuic",
                    "It's a mountain that you can access by an aerial lift, or by subway connecting with a funicular railway or just walking. There you'll find a lot to do, the full of Catalunya history castle, the cemetery, different museums, the Anella Olimpica, huge gardens or the Font Magica.\n" +
                            "It's a gorgeous place that deserves the time to fully appreciate its attractions.",
                    4.7,
                    12.45,
                    "Barcelona",
    ...
    public List<MuseumModel> getAllMuseums(@PathVariable("cityName") String cityName){
        return allMuseums.stream().filter(museum -> museum.getCityName().equals(cityName)).collect(Collectors.toList());
    }

    @GetMapping(value = "/top-museums")
    public List<MuseumModel> getTopMuseums(){
        return allMuseums.stream().filter(museum -> museum.getRating()> 4.4).collect(Collectors.toList());
    }
}